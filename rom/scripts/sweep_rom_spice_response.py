#!/usr/bin/env python3
"""Characterize the hierarchical MASK NOR-ROM over code and parasitic corners.
...
def run_corner(
    ...
    with tempfile.NamedTemporaryFile(
        mode="w", suffix=".cir", prefix="rom_char_", delete=False
    ) as handle:
        handle.write(source)
...
def main() -> None:
    ...
    parser.add_argument("--output", default="results/rom_spice_response.tsv")
